...
constructor(
    ...
    private fun Npc.processMode(mode: NpcMode): Unit =
        when (mode) {
            ...
            NpcMode.OpPlayer6 -> aiPlayerMode.processOp(this, InteractionOp.Op6)
            NpcMode.OpPlayer7 -> aiPlayerMode.processOp(this, InteractionOp.Op7)
            NpcMode.OpPlayer8 -> aiPlayerMode.processOp(this, InteractionOp.Op8)
            ...
            NpcMode.ApPlayer6 -> aiPlayerMode.processAp(this, InteractionOp.Op6)
            NpcMode.ApPlayer7 -> aiPlayerMode.processAp(this, InteractionOp.Op7)
            NpcMode.ApPlayer8 -> aiPlayerMode.processAp(this, InteractionOp.Op8)
